...
public class Ball3DHardAgent : Agent
{
    ...
    [SerializeField]
    GameObject agent_head_center = null;
    public float distance = 0;
    public float last_distance = 1000000;
...

    {
        ...
        distance = Vector3.Distance(ball.transform.position, agent_head_center.transform.position);
        ...
        if(m_BallRb.velocity.magnitude <= 2f)
        {
            SetReward(0.01f);
        }
        else
